...
// src/runtime-app/ui/app/App.ts
var _dec = [
  customElement("agent-runtime-shell")
];
var _base = LitElement;
var _dec2 = [
  state()
];
var _dec3 = [
...
class AgentRuntimeShell extends _base {
  constructor() {
    super(...arguments);
    this.snapshot = __runInitializers(_init, 8, this, window.__RUNTIME_APP__);
    __runInitializers(_init, 11, this);
    this.activeTab = __runInitializers(_init, 12, this, "dashboard");
...
__decorateElement(_init, 5, "snapshot", _dec2, AgentRuntimeShell);
__decorateElement(_init, 5, "activeTab", _dec3, AgentRuntimeShell);
AgentRuntimeShell = __decorateElement(_init, 0, "AgentRuntimeShell", _dec, AgentRuntimeShell);
__runInitializers(_init, 1, AgentRuntimeShell);
__decoratorMetadata(_init, AgentRuntimeShell);
let _AgentRuntimeShell = AgentRuntimeShell;

// src/runtime-app/ui/app/main.ts
